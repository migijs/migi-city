...
class MigiCity extends migi.CacheComponent {
  ...
  render() {
    ...
    var showCoutry = args.showCoutry;

    var name = args.name;
    var cityName = args.cityName;
    var coutryName = args.coutryName;
    ...
    return <div>
        ...
        <Select name={ coutryName } style={ showCoutry ? 'margin-left:10px' : 'display:none' } list={ list[0].citys[0].countys } allowPropagation="1"/>
      </div>;
  }
}
